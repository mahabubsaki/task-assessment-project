        ...
        <div className="flex items-center min-h-[500px] w-full">
            <div className="w-full bg-white rounded shadow-2xl p-8 m-4 sm:max-w-sm sm:mx-auto">
                ...
                <form className="mb-4" onSubmit={handleLogin}>
                    ...
                    <div className="mb-6 sm:w-full relative">
                ...
                <label htmlFor="my-modal-3" className="text-primary text-center text-sm btn btn-ghost">Forgot password?</label>
                ...
                <div className="modal">
                    <div className="modal-box relative">
                        ...
                        <h3 className="text-lg font-bold mb-3">Reset Your Password</h3>
                        <form onSubmit={handleForgetPassword}>
                            <input type="email" name="email" id="email" placeholder="Enter Your Email" className="w-full border rounded p-2 outline-none focus:shadow-outline bg-[#eeebeb]" required />
                        ...
                        {sending && <div className="flex justify-center">
                            <svg role="status" className="inline w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-purple-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
